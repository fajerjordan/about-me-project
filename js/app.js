...
function checkanswer () {
    ...
    } else if (q1.toUpperCase() === "N" || (q1.toLowerCase() === "no"){
...
function checkanswer () {
    ...
    } else if (q2.toUpperCase() === "N" || (q2.toLowerCase() === "no"){
        // console.log ("Your answer i Wrong ~_~")
        alert ("Your answer is Wrong ~_~ ")
...
function checkanswer () {
    ...
    } else if (q3.toUpperCase() === "N" || (q3.toLowerCase() === "no"){
        // console.log ("Your answer i Wrong ~_~")
        alert ("Your answer is Wrong ~_~ ")
...
function checkanswer () {
    ...
    } else if (q4.toUpperCase() === "N" || (q4.toLowerCase() === "no"){
        // console.log ("Your answer i Wrong ~_~")
        alert ("Your answer is Wrong ~_~ ")
...
function checkanswer () {
    ...
    } else if (q5.toUpperCase() === "N" || (q5.toLowerCase() === "no"){
        // console.log ("Your answer i Wrong ~_~")
        alert ("Your answer is Wrong ~_~ ")
